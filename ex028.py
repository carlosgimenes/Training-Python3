...
# Desafio 028 - Jogo de Adivinhação v.1.0
...
# Link para a resolução: https://youtu.be/kchC5KLZSZ4
# =================================================================================================

# Como foi resolvido

from random import randint  # Aqui importamos apenas a função "randint" do módulo "random", deta 
                            # forma não carrego o módulo inteiro
